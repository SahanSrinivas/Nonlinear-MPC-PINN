...
if __name__ == "__main__":
    ...
    ap.add_argument("--protocol", choices=["grid", "paper-aprbs"], default="grid",
                    help="Training data protocol. 'grid' (default): 10x10 dense "
                         "(Q_f, Q_c) grid with 60-80 min holds, covers test corners "
                         "by construction. 'paper-aprbs': paper's exact APRBS "
                         "(reproduces paper-protocol but very seed-sensitive).")
    ...
    print("=" * 70)
    print(f"NARX baseline (paper Table 2 reference: Test1=0.001508, Test2=0.01934)")
