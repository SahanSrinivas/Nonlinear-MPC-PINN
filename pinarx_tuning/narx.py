...
if __name__ == "__main__":
    ...
    from data_gen import (gen_training_set, gen_validation_set,
    ...
    tr = gen_training_set(N=args.n_train, seed=args.seed)
    va = gen_validation_set(N=args.n_val,  seed=args.seed + 1)
    t1 = gen_test1_set()
    t2 = gen_test2_set()
